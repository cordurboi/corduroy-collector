...
3. **Claim an artwork using the sample poster**  
   - Open the shared folder with sample art:  
     [https://drive.google.com/drive/folders/10VnQWHqKoQC00s0KHoDMLnuTxG24AwGj?usp=drive_link](https://drive.google.com/drive/folders/10VnQWHqKoQC00s0KHoDMLnuTxG24AwGj?usp=drive_link)
